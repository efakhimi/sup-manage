        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal"  method="POST" action="{{ route('categoryUpdateSave')."/".$cat->id }}">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="catTitle" name="name" placeholder="عنوان دسته‌بندی" value="{{ $cat->name }}">
                            </div>
                        </div>
                        <div class="form-group ">
                            ...
                            <div class="col-sm-10">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="catActive" name="active" {{ ($cat->active ? "checked" : "") }}>
